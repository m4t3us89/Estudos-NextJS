export default function QuemSomos() {
  return (
    <h6>
      Passagem padrão original de Lorem Ipsum, usada desde o século XVI. "Lorem
      ...
      laborum." Seção 1.10.32 de "de Finibus Bonorum et Malorum", escrita por
      Cícero em 45 AC "Sed ut perspiciatis unde omnis iste natus error sit
      ...
      fugiat quo voluptas nulla pariatur?" Tradução para o inglês por H. Rackha,
      feita em 1914 "But I must explain to you how all this mistaken idea of
      ...
      avoids a pain that produces no resultant pleasure?" Seção 1.10.33 de "de
      Finibus Bonorum et Malorum", escrita por Cícero em 45 AC "At vero eos et
      ...
      perferendis doloribus asperiores repellat." Tradução para o inglês por H.
      Rackha, feita em 1914 "On the other hand, we denounce with righteous
